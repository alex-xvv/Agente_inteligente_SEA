...
public class Opcion2GUI extends JFrame implements KeyListener {
    private JLabel etiqueta;
    private int opcionSeleccionada;

    public Opcion2GUI() throws IOException {
        super("Opción 2");
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        python voz = new python();
        voz.hablar("Opcion 2");
        etiqueta = new JLabel("Selecciona una opción para Opción 2:");
